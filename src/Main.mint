...
async component PageSrc {
	...
	fun render {
		Json.stringify(API.call(Json.parse("{\"action\": \"src\"\, \"q\": \"#{(`encodeURIComponent(#{Store.src})`)}\"}")))
	}
}
